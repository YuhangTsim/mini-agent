...
def _save_config(
    ...
    lines.extend([
        ...
        "debug = false",
        "",
        "# === Glob-based Permission Rules (shared by both agents) ===",
        "# First-match-wins. Highest priority rules go first.",
        "# Uncomment to deny access to sensitive files:",
        '# [[permissions]]',
        '# agent = "*"',
        '# tool = "*"',
        '# file = ".env*"',
        ...
        "",
        "# Per-tool/group approval defaults (compiled into low-priority permission rules)",
        "[tool_approval]",
        'read = "auto_approve"        # group: read_file, search_files, list_files',
        'edit = "always_ask"          # group: write_file, edit_file',
        'command = "always_ask"       # group: execute_command',
        ...
        "max_concurrent = 3",
        "",
        "# Per-tool/group approval defaults for open-agent",
        "[open_agent.tool_approval]",
        'read = "auto_approve"        # group: read_file, search_files, list_files',
        'edit = "always_ask"          # group: write_file, edit_file',
        'command = "always_ask"       # group: execute_command',
